                    ...
                    <div class="col-1 new-users">
                        ...
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <a href="{{ route('login') }}" title="Already have an Account" class="button create-account" style="background-color: #88be4c;"><span><b>Customer Login</b></span></a>
                                <a href="{{route('vendor-register')}}" title="Already have an Account" class="button create-account" style="background-color: #88be4c;"><span><b>Merchant Register</b></span></a>
