...
<div class="page-heading" style="background-image: url(/sweet/public/images/products/logo/{{$brand['brand_logo']}});">
            ...
            <div>
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active"><img src="{{URL::to('/')}}/public/images/products/logo/{{$brand['brand_logo']}}" alt="slide3" style="width:100%; height:100%;">
...
<script>
    $('#sortBy').change(function() {
        ...
        window.location = "{{url(''.$route.'')}}/{{$vendor_id}}?sort=" + sort;
    });
</script>
@endsection