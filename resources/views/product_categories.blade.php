...
<div class="page-heading" style="background-image: url(/sweet/public/images/categories/{{$categories->image_url2}});">
                ...
                <ul>
                    ...
                    <li> <a class="active" href="{{route('product-cat',$cat->slug)}}">{{ucfirst($cat->title)}}</a> <span class="subDropdown minus"></span>
                        <ul class="level0_415" style="display:block">
                            ...
                            <li>
                                <a href="{{route('product-cat',$child_cat->slug)}}"> {{ucfirst($child_cat->title)}} </a>
