                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{route('vendor-product-varients-show',$row['id'])}}"><i class="fas fa-eye"></i></a>
                                            <a class="btn btn-info btn-sm" href="{{route('vendor-product-edit',$row['id'])}}"><i class="fas fa-pencil-alt"></i></a>
