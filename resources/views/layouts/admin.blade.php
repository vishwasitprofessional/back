      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="{{route('pending-vendors-show')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Pending Vendors</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="{{route('approved-vendors-show')}}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
            ...
            <!-- <li class="nav-item">
              <a href="{{--route('varient-filters-show')--}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Varient Filter
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('contact-forms-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Contact Details
                </p>
            ...
            <!-- {{--<li class="nav-item">
              <a href="{{route('reviews-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Add Reviews
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('videos-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Add Videos
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('google-reviews-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Add Google Reviews
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('email-subscribers-show')}}" class="nav-link">
                <i class="nav-icon far fa-user"></i>
                <p>
                  Email Subscribers
                </p>
