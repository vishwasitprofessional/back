    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div align="right">
                        <a href="{{route('brand-create')}}" class="btn btn-primary">Add New Brand</a><br>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    @if(!empty($row->image_url))
                                                        <img alt="Avatar" class="table-avatar" src="{{URL::to('/')}}/public/images/brands/{{$row->image_url}}" height="50" width="50">
                                                    @endif
                                                </li>
                                            </ul>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{route('brand-edit',$row['id'])}}"><i class="fas fa-pencil-alt"></i></a>
                                            <form name="myForm" method="POST" action="{{route('brand-delete',$row['id'])}}" class="float-right">
                                                @csrf
...
<script>
    $(document).ready(function() {
        $('input[name=toogle]').change(function() {
            ...
            // alert(id);
            $.ajax({
                url: "{{ route('ajax-brand-status-update') }}",
                method: "POST",
                data: {
                    _token: '{{csrf_token()}}',
                    mode: mode,
