    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div align="right">
                        <a href="{{route('product-create')}}" class="btn btn-primary">Add One Product</a>
                        <a href="{{route('bulk-product-create')}}" class="btn btn-primary">Add Bulk Products</a><br>
                    </div>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @if(!empty($row->relChildCategory->id))
                                    <tr>
                                        <td>{{$row['id']}}</td>
                                        
                                        <!-- <td><a>{{--$row->relCategory['title']--}}</a></td> -->
                                        <td>{{$row->relChildCategory['title']}}</td>
                                        ...
                                        <td>
                                            <!-- <a class="btn btn-primary btn-sm" href="{{--route('product-view',$row['id'])--}}"><i class="fas fa-eye"></i></a> -->
                                            <a class="btn btn-info btn-sm" href="{{route('product-edit',$row['id'])}}"><i class="fas fa-pencil-alt"></i></a>
                                            <a class="btn btn-primary btn-sm" href="{{route('product-varients-show',$row['id'])}}"><i class="fas fa-eye"></i></a>
