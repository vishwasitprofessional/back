    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div align="right">
                        <a href="{{route('popular-product-create')}}" class="btn btn-primary">Add New Popular Product</a><br>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{route('popular-product-edit',$row['id'])}}"><i class="fas fa-pencil-alt"></i></a>
                                            <form name="myForm" method="POST" action="{{route('popular-product-delete',$row['id'])}}" class="float-right">
                                                @csrf
...
<script>
    $(document).ready(function() {
        $('input[name=toogle]').change(function() {
            ...
            // alert(id);
            $.ajax({
                url: "{{ route('ajax-popular-product-status-update') }}",
                method: "POST",
                data: {
                    _token: '{{csrf_token()}}',
                    mode: mode,
