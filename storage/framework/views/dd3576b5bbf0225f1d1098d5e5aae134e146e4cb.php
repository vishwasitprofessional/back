...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(route('vendor-index')); ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php echo e(route('vendor-index')); ?>" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if(Auth::user()->approved_status=='approved'): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('vendor-index')); ?>" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('vendor-profile-show')); ?>" class="nav-link">
                                <i class="nav-icon far fa-user"></i>
                                <p>
                                    Profile
                                </p>
                        ...
                        <?php if(Auth::user()->approved_status=='approved'): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('vendor-products-show')); ?>" class="nav-link">
                                <i class="nav-icon far fa-user"></i>
                                <p>
                                    Products
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('vendor-orders-show')); ?>" class="nav-link">
                                <i class="nav-icon far fa-user"></i>
                                <p>
                                    Orders
                                </p>
...
</html><?php /**PATH /home/shreshta/public_html/resources/views/layouts/vendor.blade.php ENDPATH**/ ?>