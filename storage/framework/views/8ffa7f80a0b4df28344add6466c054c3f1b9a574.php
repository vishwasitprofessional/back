...
<div class="page-heading" style="background-image: url(/sweet/public/images/brands/logo/<?php echo e($vendors['brand_logo']); ?>);">
    ...
    <div class="page-title">
        <h2><?php echo e($vendors['brand_name']); ?></h2>
    </div>
</div>
<!--breadcrumbs-->
                ...
                <ul>
                    ...
                    <li> <a class="active" href="<?php echo e(route('product-cat',$cat->slug)); ?>"><?php echo e(ucfirst($cat->title)); ?></a> <span class="subDropdown minus"></span>
                        <ul class="level0_415" style="display:block">
                            ...
                            <?php if(!empty(get_brands()[$child_cat->id])): ?>
                            <?php $__currentLoopData = get_brands()[$child_cat->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand_id=>$brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <?php if($brand_id==$vendor_id): ?>
                                <a href="<?php echo e(route('product-brand')); ?>/<?php echo e($child_cat->id); ?>/<?php echo e($brand_id); ?>"> <?php echo e(ucfirst($child_cat->title)); ?> </a>
            ...
            <div class="block block-layered-nav">
                ...
                <div class="block-content">
                    ...
                    <dl id="narrow-by-list">
                        ...
                        <?php if(!empty($brand['rel_product'])): ?>
                        <?php if($brand['rel_product'][$c]['cat_id']==$cat_id): ?>
                        <div class="col-sm-12">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <!--<div class="carousel-inner">-->
                        <div class="item active">
                            <img src="<?php echo e(URL::to('/')); ?>/public/images/brands/logo/<?php echo e($vendors['brand_logo']); ?>" alt="<?php echo e($vendors['brand_logo']); ?>" style="width:100%; height:100%;">
...
<script>
    $('#sortBy').change(function() {
        ...
        window.location = "<?php echo e(url(''.$route.'')); ?>/<?php echo e($cat_id); ?>/<?php echo e($vendor_id); ?>?sort=" + sort;
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shreshta/public_html/resources/views/product_brands.blade.php ENDPATH**/ ?>