...
<div class="main-container col1-layout wow bounceInUp animated animated" style="visibility: visible;">
    ...
    <div class="main">
        <div class="account-login container">
            ...
            <form method="POST" action="<?php echo e(route('vendor-register-action')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-1 new-users">
                        ...
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <a href="<?php echo e(route('login')); ?>" title="Already have an Account" class="button create-account" style="background-color: #88be4c;"><span><b>Merchant Login</b></span></a>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shreshta/public_html/resources/views/vendor/vendor_register.blade.php ENDPATH**/ ?>