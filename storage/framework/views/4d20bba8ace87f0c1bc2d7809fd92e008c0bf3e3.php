        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            ...
            <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#ffffff" >
              <tr> <td style="background-color:#ffffff;"> <br><br>
                <center>
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align:center; color: #6f6f6f;">
                        <h2 align='center'>Email Heading</h2> 
                  <?php echo $body; ?>
                ...
                <table style="margin:0 auto;" cellspacing="0" cellpadding="10" width="100%">
                  <tr>
                    <td style="text-align:center; margin:0 auto;"><br> <br> </td>
                  </tr>
                </table>
                <table cellspacing="0" cellpadding="0" bgcolor="#363636" style="width: 100%"  class="force-full-width">
                  <tr> <td style="background-color:#363636; text-align:center;"> <br> </td>
                  </tr>
                  <tr>
                    <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;"> © 2019 All Rights Reserved </td>
                  </tr>
                  <tr>
                    <td style="color:#27aa90; font-size: 14px; text-align:center;">
                      <a href="<?php echo e(URL::to('/')); ?>">View in browser</a>
                    </td>
                  </tr>
                  <tr>
...
<?php /**PATH /home/shreshta/public_html/resources/views/email.blade.php ENDPATH**/ ?>