                    ...
                    <div class="col-1 new-users">
                        ...
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                <a href="<?php echo e(route('register')); ?>" title="Create an Account" class="button create-account" style="background-color: #88be4c;"><span><b>Register</b></span></a>
                    ...
                    <div class="col-2 registered-users">
                        ...
                        <div class="content">
                            ...
                            <div class="buttons-set">
                                ...
                                <button type="submit" class="button login" title="Login" name="send" id="send2" style="background-color: #88be4c;"><span><?php echo e(__('Log in')); ?></span></button>

                                <?php if(Route::has('password.request')): ?>
                                <a class="forgot-word" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shreshta/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>